...
class DefaultImageService: ImageService {
        ...
        return Observable.just(imageData)
            ...
            .map { data in
                guard let image = UIImage(data: data) else {
                    // some error
                    throw BasicError.make("Decoding image error")
                }
    ...
    */
    func imageFromURL(_ url: URL, reachabilityService: ReachabilityService? = Dependencies.sharedDependencies.reachabilityService) -> Observable<DownloadableImage> {
